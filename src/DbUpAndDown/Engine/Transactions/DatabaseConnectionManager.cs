    ...
    public abstract class DatabaseConnectionManager : IConnectionManager
    {
        ...
        public IDisposable OperationStarting(IUpgradeLog upgradeLog, List<SqlScript> executedScripts)
        {
            ...
            if (transactionStrategy != null)
                throw new InvalidOperationException("OperationStarting is meant to be called by DbUpAndDown and can only be called once");
        ...
        /// <summary>
        /// The transaction strategy that DbUpAndDown should use
        /// </summary>
