...
using DbUpAndDown.SQLite;
using DbUpAndDown.SQLite.Helpers;
using DbUpAndDown.Support.SQLite;
using NSubstitute;
...
namespace DbUpAndDown.Tests
{
    [TestFixture]
    [Story(
        AsA = "As a DbUpAndDown User",
        IWant = "I want to DbUpAndDown to upgrade my database to the latest version",
